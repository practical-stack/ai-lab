...
|---|--------|----------|-------------|
| 1 | [Fundamentals](./01-fundamentals.en.md) | 20 min | Core concepts: Command, Skill, Agent |
| 2 | [Relationships](./02-relationships.en.md) | 25 min | How components work together |
| 3 | [Decision Framework](./03-decision-framework.en.md) | 20 min | When to build what |
| 4 | [Design Templates](./04-templates.en.md) | 30 min | Ready-to-use spec formats |
| 5 | [Real Examples](./05-examples.en.md) | 35 min | Complete implementations |
| 6 | [Anti-patterns](./06-anti-patterns.en.md) | 25 min | Mistakes to avoid |
...
| Source | Description |
|--------|-------------|
| [Research Prompt](../research/00-research-prompt.en.md) | Original meta-prompt used for research |
| [Claude Research](../research/01-claude.en.md) | Claude's response - AI coding assistant patterns |
| [GPT Research](../research/02-gpt/) | GPT's response - Comprehensive taxonomy (6 parts) |
| [Gemini Research](../research/03-gemini.en.md) | Gemini's response - Enterprise perspective |
