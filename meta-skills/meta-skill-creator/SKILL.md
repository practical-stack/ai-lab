...
> **Output Language**: All generated skill content (SKILL.md, comments, documentation) will be in **Korean (한국어)**.
...
```
skill-name/
├── SKILL.md              # Template with Korean placeholders
├── scripts/
...
description: |             # Required: triggers + purpose (Korean)
  스킬 설명과 사용 시점을 명시합니다.
...
- Include helpful error messages (in Korean for user-facing)
...
- **Output Templates**: See [assets/templates/](assets/templates/) for Korean templates
